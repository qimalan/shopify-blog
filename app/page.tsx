			...
			<main className="min-h-screen flex flex-col justify-center px-8 md:px-16 py-20 md:py-24 overflow-hidden">
				<div className="max-w-300 mx-auto w-full space-y-16 md:space-y-20">
					...
					<section className="flex flex-col lg:flex-row lg:items-center lg:gap-16 gap-8">
						...
						{/* Profile Image */}
						<div className="w-full lg:w-auto lg:-mr-12.5 -z-10">
							<div className="relative aspect-9/16 lg:h-175 lg:w-auto w-full">
								<Image
									...
									priority
									quality={90}
									className="h-full w-full object-cover grayscale transition-all duration-2000 ease-out hover:scale-105 hover:grayscale-0"
								/>
							</div>
						</div>
					</section>
